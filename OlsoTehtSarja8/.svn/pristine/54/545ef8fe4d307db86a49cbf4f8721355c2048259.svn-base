...
import controller.Tehtava4Ohjain;
...
public class Tehtava4NoppaGUI extends Application {
	@Override
	public void start(Stage primaryStage) {
		try {
			IView ohjain = new Tehtava4Ohjain();
			...
			hettoBTN.setOnAction(new EventHandler<ActionEvent>(){
				...
				public void handle(ActionEvent event) {
					...
					System.out.println("Arvot: " + ohjain.tulos() + ", Heittojen Lukumäärä: " + ohjain.heittojenLkm());
				}
			});
